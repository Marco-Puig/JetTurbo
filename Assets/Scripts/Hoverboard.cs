    ...
    {   
        if (Input.GetKey(KeyCode.Mouse1) || Input.GetAxis("RT") > 0)
        {
            ...
            if (Input.GetKey(KeyCode.Mouse1))
                hb.AddForce(Input.GetAxis("Fire2") * moveForce * hb.transform.forward);
            else if (Input.GetAxis("RT") > 0)
                hb.AddForce(Input.GetAxis("RT") * moveForce * hb.transform.forward * 1.263f);
            //if not drifting 
            if (!(l == true || r == true))
                hb.AddForce(Input.GetAxis("Horizontal") * moveForceDefault * hb.transform.right); 
            //if not drifting (also might have remove this eventually):
            if (!(l == true || r == true))
                hb.AddTorque(Input.GetAxis("Horizontal") * 100 * hb.transform.up);  
            ...
            {
                //regular movement
                hb.AddForce(Input.GetAxis("Vertical") * moveForce * hb.transform.forward);
                //if not drifting 
                if (!(l == true || r == true)) 
                    hb.AddForce(Input.GetAxis("Horizontal") * moveForce * hb.transform.right);   
        ...
        if ((at.trickBoost || driftBoost)){
            if (Input.GetKey(KeyCode.Mouse1) || Input.GetAxis("RT") > 0){
                if (Input.GetKey(KeyCode.Mouse1))
                    ...
                    hb.AddForce(Input.GetAxis("RT") * 5000 * hb.transform.forward * 1.263f);                
            }

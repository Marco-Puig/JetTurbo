...
public class RailGrindOffline : MonoBehaviour
{
    ...
    public HoverboardOffline hbs; //player
    ...
    private void FixedUpdate()
    {
        if (isGrinding)
        {
            ...
            hbs.transform.rotation = Quaternion.Lerp(startPoint.rotation, endPoint.rotation, t);
